...
import mhstore.apparel.mhstylerush.di.dataModule
import mhstore.apparel.mhstylerush.di.dispatcherModule
import mhstore.apparel.mhstylerush.di.viewModule
...
class JNVNJApplication : Application() {
    //[FIREBASE][appScope]
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@JNVNJApplication)
            modules(appModules)
        }
